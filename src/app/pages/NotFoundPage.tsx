...
export default function NotFoundPage() {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
      <div style={{ backgroundColor: '#E8F5F0' }} className="w-20 h-20 rounded-2xl flex items-center justify-center mb-6">
      ...
      <div className="flex gap-3">
        ...
        <button onClick={() => navigate('/')} className="px-5 py-2.5 rounded-xl text-white text-sm font-medium hover:opacity-90 transition-opacity" style={{ backgroundColor: '#1A7A5E' }}>
          Home
        </button>
      </div>
    </div>
